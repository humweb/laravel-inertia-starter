        ...
        <Combobox as="div" v-model="selected" :multiple="multiple" class="text-gray-700">
            ...
            <div class="relative mt-1">
                <ComboboxInput
                    ...
                    @change="query = $event.target.value" :display-value="(option) => option||''"
...
export default {
    ...
    methods: {
        getValue(option) {
            return typeof this.options === 'object' ? option[this.valueKey] : option;
        },
        getLabel(option) {
            return typeof this.options === 'object' ? option[this.labelKey] : option;
        },
    },
    computed: {
        selected: {
        ...
        filtered() {
            return this.query.value === ''
                ...
                : this.options.filter((opt) => {
                    return this.getValue(opt).toString().toLowerCase().indexOf(this.query.toLowerCase()) !== -1;
                });
        },
